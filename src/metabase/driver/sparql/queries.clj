...
;;
;; Usage:
;;   Used by the driver/can-connect? method to verify endpoint availability
;;   A successful execution of this query indicates that the endpoint is accessible
...
;;   Each RDF class is treated as a table in the Metabase data model
